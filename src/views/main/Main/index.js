        ...
        <Col md={12}>
          <Card>
            ...
            <Card.Body>
              ...
              <blockquote className="blockquote text-right">
                <footer className="blockquote-footer">
                  <cite title="Source Title">Результати II етапу Всеукраїнських учнівських олімпіад з навчальних предметів у 2021-2022 н.р.</cite>
                </footer>
              </blockquote>
            </Card.Body>
          </Card>
        ...
        <Col md={12}>
          <Card>
            ...
            <Card.Body>
              ...
              <blockquote className="blockquote text-right">
                <Card.Text className="mb-2">
                  <a target="_blank" rel="noreferrer" href="https://docs.google.com/forms/d/e/1FAIpQLSewMlxwE6M45eD6MC_U1Pu5fW4U_lYc0ef6Kr0N_ZOBKH46cQ/viewform">
                  учні закладів загальної середньої освіти
                  </a>
                </Card.Text>
                <footer className="blockquote-footer">
                  <cite title="Source Title">З метою залучення до навчання учнів із числа внутрішньо переміщених осіб на території Івано-Франківської територіальної громади необхідно зареєструватися за посиланням</cite>
                </footer>
                ...
                <a target="_blank" rel="noreferrer" href="https://docs.google.com/document/d/1b3SzLv8x0xMGTjNMG5CqDwyRE00QSUi5/edit">
                  <div className="section__box">
                    <div className="section__content">
                      ...
                      <p>Як діяти у випадку, якщо на території, де ви перебуваєте, розпочалися військові дії або стався терористичний акт.</p>
                    </div>
                  </div>
                </a>
              </blockquote>
